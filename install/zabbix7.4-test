...
msg_info "Installing Zabbix 7.4"
cd /tmp

# --- MODIFICATION 1: Hardcode the URL for Zabbix 7.4 ---
curl -fsSL "https://repo.zabbix.com/zabbix/7.4/debian/pool/main/z/zabbix-release/zabbix-release_7.4-1+debian13_all.deb" \
  -o /tmp/zabbix-release_7.4-1+debian13_all.deb

# --- MODIFICATION 2: Install the specific .deb file for 7.4 ---
$STD dpkg -i /tmp/zabbix-release_7.4-1+debian13_all.deb

$STD apt update

# --- MODIFICATION 3: Change PHP version from 8.4 to 8.3 for compatibility ---
$STD apt install -y zabbix-server-pgsql zabbix-frontend-php php8.3-pgsql zabbix-apache-conf zabbix-sql-scripts
...
rm -rf /tmp/zabbix-release_7.4-1+debian13_all.deb
